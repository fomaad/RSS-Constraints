...
from safety_analysis import main as safety_analysis_main
...
def step3_safety_analysis():
    ...
    print("\n" + "="*50)
    print("STEP 3: Crash Detection and Safety Constraint Analysis")
    print("="*50)
...
def print_final_summary():
    ...
    key_files = [
        ...
        (os.path.join(RESULTS_OUTPUT_DIR, "safety_analysis_summary.csv"), "Safety Analysis Summary"),
        (os.path.join(RESULTS_OUTPUT_DIR, "safety_analysis_report.md"), "Final Analysis Report")
    ]
    ...
    print(f"  {os.path.join(RESULTS_OUTPUT_DIR, 'safety_analysis_report.md')}")
